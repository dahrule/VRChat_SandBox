...
-The system indicates on a UI the following: 1. current portal’s capacity, 2. the role linked to that portal 3. the action occurring when entering the portal (either get or release role).
...
-For testing go to Menu: VRChat SDK - Show control panel - Builder - Build & test (num clients: 2+; Force none VR: true). Must have a VRChat account to access the Builder tab
